<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script src="${contextPath}/static/js/backstage/js/charts.js"></script> <!-- All the above chart related functions -->
<!-- All JS functions -->
<script src="${contextPath}/static/js/page/mainContent.js"></script>
<!-- Messages Drawer -->
<div id="messages" class="tile drawer animated">
    <div class="listview narrow">
        ...
        <div class="overflow" style="height: 254px">
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="${contextPath}/static/js/backstage/img/profile-pics/1.jpg" alt="">
                </div>
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="${contextPath}/static/js/backstage/img/profile-pics/2.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="${contextPath}/static/js/backstage/img/profile-pics/3.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="${contextPath}/static/js/backstage/img/profile-pics/4.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="${contextPath}/static/js/backstage/img/profile-pics/5.jpg" alt="">
                </div>
                <div class="media-body">
...
<div class="block-area shortcut-area">
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/money.png" alt="">
        <small class="t-overflow">购买</small>
    </a>
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/twitter.png" alt="">
        <small class="t-overflow">推文</small>
    </a>
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/calendar.png" alt="">
        <small class="t-overflow">日历</small>
    </a>
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/stats.png" alt="">
        <small class="t-overflow">统计信息</small>
    </a>
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/connections.png" alt="">
        <small class="t-overflow">连接</small>
    </a>
    <a class="shortcut tile" href="">
        <img src="${contextPath}/static/js/backstage/img/shortcuts/reports.png" alt="">
            ...
            <div class="tile">
                ...
                <div class="tile-config dropdown">
                    ...
                    <ul class="dropdown-menu pull-right text-right">
                        <li><a class="tile-info-toggle" href="">海图信息</a></li>
                        <li><a href="">刷新</a></li>
                        <li><a href="">设置</a></li>
                    </ul>
                </div>
            ...
            <div class="tile text-center">
                <div class="tile-dark p-10">
                    ...
                    <div class="pie-chart-tiny" data-percent="57">
                        <span class="percent"></span>
                        <span class="pie-title">发送电子邮件 <i class="m-l-5 fa fa-retweet"></i></span>
                    </div>
                    <div class="pie-chart-tiny" data-percent="34">
                        <span class="percent"></span>
                        <span class="pie-title">销售率<i class="m-l-5 fa fa-retweet"></i></span>
                    </div>
                    ...
                    <div class="tile">
                        ...
                        <div class="listview narrow">
                            <div class="media p-l-5">
                                ...
                                <div class="media-body">
                                    <small class="text-muted">2个小时前由 Adrien San</small><br/>
                            ...
                            <div class="media p-l-5">
                                ...
                                <div class="media-body">
                                    <small class="text-muted">5个小时前由 David Villa</small><br/>
                            ...
                            <div class="media p-l-5">
                                ...
                                <div class="media-body">
                                    <small class="text-muted">在 15/12/2013 由 Mitch bradberry</small><br/>
                            ...
                            <div class="media p-l-5">
                                ...
                                <div class="media-body">
                                    <small class="text-muted">在 14/12/2013 由 Mitch bradberry</small><br/>
                            ...
                            <div class="media p-l-5">
                                ...
                                <div class="media-body">
                                    <small class="text-muted">在 13/12/2013 由  Mitch bradberry</small><br/>
                                    <a class="t-overflow" href="">Integer a eros dapibus, vehicula quam accumsan, tincidunt purus</a>
